...
//#define IR_DUTY					99			/*pulse width of IRED pulse*/
//#define	IR_PAUSE				99			/*pause of IRED pulses*/
#define IR_DUTY					60			/*pulse width of IRED pulse*/
#define	IR_PAUSE				60			/*pause of IRED pulses*/
